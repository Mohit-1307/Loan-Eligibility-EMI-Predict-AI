"""
Loan Eligibilty and EMI Prediction AI - Data Insights Page
...
with c1:
    ...
    st.image(
        str(ASSETS_DIR / "chart01_eligibility_distribution.png"),
...
with c2:
    ...
    st.image(
        str(ASSETS_DIR / "chart02_max_emi_distribution.png"), use_container_width=True
    )
...
st.caption(
    "Filter the dataset yourself to see how eligibility and safe EMI shift across applicant segments."
)
...
if len(filtered) == 0:
    ...
    st.warning(
        "No applicants match this filter - widen your selection.",
    ...
    c3.metric(
        "Median Max Safe EMI",
        f"\u20b9{filtered['max_monthly_emi'].median():,.0f}",
