"""
Loan Eligibilty and EMI Prediction AI - Model Performance Page
...
st.caption(
    "All metrics below are computed on a held-out test set the models never saw during training or tuning."
)

tab_clf, tab_reg = st.tabs(
    [":material/verified: Eligibility Classifier", ":material/calculate: EMI Regressor"]
)
